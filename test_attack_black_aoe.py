...
from setup_imagenet_hash3 import ImageNet, ImageNet_HashModel
#from setup_maladv_hash import MalAdv, MalAdv_HashModel
# from l2_attack import CarliniL2
from l2_attack_black_eot import BlackBoxL2
...
def main(args):
    ...
    with tf.Session(config=config) as sess:
        ...
        #for i in start_idxs:
            ...
            gray_inputs_t1, gray_inputs_t2, gray_inputs_t3 = generate_transformation(gray_inputs, i)
            ...
            if len(gray_inputs_t1.shape) == 3: 
                ...
                # print("========gray t1 shape ", gray_inputs_t1.shape, gray_inputs_t2.shape, gray_inputs_t3.shape)
            timestart = time.time() 
            ...
            adv, const, L3, adv_current, first_iteration= attack.attack_batch(gray_inputs, inputs, gray_inputs_t1, gray_inputs_t2, gray_inputs_t3, i)
            timeend = time.time()
